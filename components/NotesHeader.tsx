...
export default function NotesHeader({ title, tagName }: NotesHeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-neutral-200 px-8 py-[1.625rem]">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          {/* Search Bar */}
          <div className="relative flex items-center gap-2 px-3 py-2 border border-neutral-300 rounded-[.5rem] hover:bg-neutral-50 focus-within:ring-2 focus-within:ring-neutral-500 focus-within:ring-offset-2 focus-within:ring-offset-white focus-within:border-neutral-950 transition-shadow duration-300">
            <span aria-hidden="true">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" className="fill-current text-neutral-500">
                <path fillRule="evenodd" d="M11.248 3.5a7.289 7.289 0 1 0 0 14.577 7.289 7.289 0 0 0 0-14.577ZM2.46 10.79a8.789 8.789 0 1 1 17.577 0 8.789 8.789 0 0 1-17.577 0Z" clipRule="evenodd"/>
                <path fillRule="evenodd" d="m16.736 15.648 5.616 5.6-1.06 1.063-5.615-5.601 1.06-1.062Z" clipRule="evenodd"/>
              </svg>
            </span>
            <label htmlFor="notes-search" className="sr-only">Search by title, content, or tags...</label>
            <input
              id="notes-search"
              type="text"
              ...
              className="w-64 text-neutral-950 text-preset-5 outline-none bg-transparent placeholder:text-neutral-500"
            />
          </div>
